        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 ">
          ...
          <div>
            <div className="mb-4">
              <Link to="/">
                {" "}
                <img src={logo} alt="" className=" h-[60px] w-[220px]" />
              </Link>
            </div>
            <p className="text-white text-sm">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur
              deserunt delectus rem, harum eveniet quo sed, molestiae aspernatur
              tempore distinctio, adipisci quaerat molestias vel minima facilis
              illo nihil illum ipsum rerum velit blanditiis perspiciatis veniam!
              Molestias voluptatem suscipit, neque quaerat repellendus, dolor
              totam provident vero alias cum amet dolore magnam!
            </p>
          </div>
